...
const SubmissionSuccess = () => {
  ...
  const { resetWizard, submissionComplete } = useWizardStore();
      ...
      >
        ...
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground">
            Your energy data has been securely recorded and is now awaiting review by your ESG manager.
          </p>
        </div>
        ...
        <motion.div
          ...
          className="bg-accent/50 border border-border rounded-xl p-6 space-y-4"
        >
